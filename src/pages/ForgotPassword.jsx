    ...
    return (
        <section>
            ...
            <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
                <div className="mid:w-[67%] lg:w-[50%] mb-12 md:mb-6">
                    <img src="https://blog.hubspot.com/hubfs/Sales_Blog/real-estate-business-compressor.jpg" alt="key"
                ...
                <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
                    <form>
                        ...
                        <div className=" flex items-center my-4 before:border-t before:flex-1 before:border-gray-300 after:-t after:flex-1 after:border-gray-300">
